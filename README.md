...
![image](https://github.com/user-attachments/assets/ca77d584-7731-4361-bd4c-900f51deca10)
...
Зная изначально посчитанные метрики основных функций можно посчиать, что rps сервиса это сумма rps всех функций MVP, где он задействован. Сами функции мы посчитали [пункте 2](#2) Таким образом: 

| Сервис         | Функции                                                                                       | RPS     |
|-----------------|-----------------------------------------------------------------------------------------------|---------|
| Auth           | Авторизация, управление учетной записью                                                       | 40      |
| Product        | Поиск товаров, добавление в корзину                                                           | 390     |
| Order          | Оформление заказов, управление заказами                                                       | 23.5    |
| Feedback       | Оставление отзывов                                                                            | 96.8    |
| PostOffice     | Определение адресов доставки                                                                  | 10      |
| Search         | Работа с БД Elasticsearch для продуктов и фидбека                                            | 483.8   |
| Recommendation | Рекомендации товаров в ленте                                                                  | 100     |

Микросервисы для проекта: 

| Сервис             | RPS     | Серверы по RPS | Сетевой трафик (Гбит/с) | Серверы по трафику | Итого серверов |
|---------------------|---------|----------------|-------------------------|--------------------|----------------|
| Auth               | 40      | 1              | 5                       | 1                  | 1              |
| Product            | 390     | 6              | 10                      | 1                  | 6              |
| Order              | 23.5    | 1              | 2                       | 1                  | 1              |
| Feedback           | 96.8    | 2              | 3                       | 1                  | 2              |
| PostOffice         | 10      | 1              | 1                       | 1                  | 1              |
| Search             | 483.8   | 7              | 20                      | 1                  | 7              |
| Recommendation     | 100     | 2              | 15                      | 1                  | 2              |
| **Итого**          | **1144.1** | **20**        | **56**                 | **7**              | **20**         |
