...
### Веб-сервисы NGINX
На официально сайте nginx ([Источник]([https://yastatic.net/s3/ir-docs/docs/2024/q2/57a1cu049ffbd144aeged36d47h173c2/MKPAO_Press_Release_RUS_rs94k.pdf](https://blog.nginx.org/blog/testing-the-performance-of-nginx-and-nginx-plus-web-servers))) видно, что сервер с 16 CPU видерживает 77 427 HTTP RPS
