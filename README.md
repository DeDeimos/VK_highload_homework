...
На основе (https://telegra.ph/Gde-data-centry-YAndeksa-03-07) можно обосновать расположение датацентров. Основная цель — снизить сетевые задержки и улучшить производительность для конечных пользователей.

Страна    | Локация ДЦ                | Обоснование
----------| --------------------------| ---------------------------------------------------------------------------
Россия    |	Москва и подмосковье	  | 95.7% пользователей из России, оптимизация для западной части страны
Россия    |	Калуга	 | Поддержка основных пользователей центральной части России
Россия    |	Рязанская область	| Поддержка основных пользователей центральной части России
Россия    |	Новосибирск	 | Покрытие для пользователей Центральной России, Урала, Сибири
Россия  |	Владимирская область | Поддержка основных пользователей центральной части России
...
Тип запроса                  |	RPS (Запад России) |	RPS (Центр России) |	RPS (Восток России) |	RPS (Китай)	| RPS (Казахстан) |	RPS (Финляндия)
-----------------------------| -------------------| -------------------| --------------------| ---------------| ----------------| -------------
Поиск товаров                |	777.71             |	259.24             |	168.41              |	28.70          |	24.24           |	7.38
Добавление товаров в корзину |	1037.88            |	345.96             |	224.75	             | 38.30          |	32.35	          | 9.85
Оформление заказов           |	259.61             |	86.54              |	56.22               |	9.58           |	8.09            |	2.46
Оставление отзывов           |	519.22             |	173.07             |	112.44              |	19.16          |	16.18           |	4.93
Главная страница	            | 5189.96            |	1729.99            |	1123.89             |	191.50         |	161.75          |	49.27
Редактирование корзины       |	519.22             |	173.07             |	112.44              |	19.16          |	16.18           |	4.93
Добавление товаров продавцом	| 1038.44            |	346.15             |	224.87              |	38.32          |	32.36	          | 9.86
Открытие карточки товара	    | 2594.98            |	864.99             |	561.94              |	95.75          |	80.88           |	24.63
Итого                        |	12195.51           |	4065.17            |	2640.94             |	449.99         |	380.09          |	115.77

Общая нагрузка распределена пропорционально процентному соотношению пользователей в каждом регионе. Запад России несет наибольшую нагрузку, следом идут центральные и восточные регионы России.
...
2. DNS-сервер будет направлять пользователей на ближайший ДЦ с учетом их географического расположения. Для пользователей в центральной России и Сибири трафик будет перенаправляться в Новосибирск, а пользователи из западной части России будут обслуживаться в Москве или Санкт-Петербурге. Восточные пользователи будут направлены в Владивосток или Хабаровск.
3. Если российские датацентры перегружены, можно перенаправить запросы на ближайший доступный ДЦ, например, в Казахстан.
...
3. Если датацентр перегружен или недоступен, Anycast перенаправляет запрос к следующему ближайшему датацентру, например, в Казахстан.
