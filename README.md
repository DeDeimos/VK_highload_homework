...
Пример для Auth:
* RPS: 642 984
* 1 сервер с 16 ядрами поддерживает 77 427 RPS.
Для расчета серверов по RPS:
```
642,984 / 77,427 = 8.3 серверов
```
Округляем до 9 серверов.

Рассчитаем количество серверов по сетевому трафику для Auth:
* Сетевой трафик для Auth: 249.5 Гбит/с
```
249.5 / 40 = 6.2 серверов
```
Округляем до 7 серверов.
...
-------------- | ------- | -------------- | ----------------------- | ------------------ | --------------
Auth           | 642,984 |	9              |	249.5                   |	7                  |	9
Search         |	839     |	1              |	0.0084                  |	1                  |	1
Profile        |	280     |	1              |	0.0053                  |	1                  |	1
Cart           |	1,120   |	2              |	0.007                   |	1                  |	2
Order          |	280     |	1              |	0.0053                  |	1                  |	1
Product        |	2,800   |	4              |	0.021                   |	1                  |	4
Comment        |	560     |	1              |	0.0035                  |	1                  |	1
Analytics      |	841     |	1              |	0.0063                  |	1                  |	1
Media          |	13,445  |	18             |	1.156                   |	1                  |	18
Moderation     |	841     |	1              |	0.0063                  |	1                  |	1
Location	      | 280     |	1              |	0.0053                  |	1                  |	1
Recommendation |	839     |	1              |	0.0084                  |	1                  |	1
Company        |	280     |	1              |	0.0053                  |	1                  |	1
Итого          |	—       |	43             |	~2.2                    |	17                 |	43
